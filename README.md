...
Modified by Zac Martindale
Original version written by AWS Consultants - Casey Labs Inc. (contact for AWS needs!)
...
- NEW: ^ Retains the first of the month by default
